...
function Register() {
	...
	return (
		<main className="min-h-screen bg-[#F5EFFF] flex flex-col">
			{/* Header spacer - prevents content from 
      being hidden under fixed headers */}
			<div className="h-[var(--navbar-height,0px)]" />

			{/* Main content */}
			<div className="flex-1 flex items-center text-pretty text-xs
       justify-center px-4 py-6 sm:px-6 lg:px-8">
				<div
					className="sm:mt-0 mt-6 border border-gray-400 sm:w-full
           w-screen sm:max-w-lg space-y-8 bg-[#F5EFFF] rounded-xl 
          shadow-sm p-6 sm:p-8 lg:p-10">
