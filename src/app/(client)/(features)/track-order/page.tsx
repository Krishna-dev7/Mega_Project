					...
					{/* <Tabs
						...
						<TabsContent
							...
							<div className="space-y-6">
								{orderDetails.trackingHistory.map(
									(event, index) => (
										<div
											key={index}
											className="relative pl-6">
											{index <
												orderDetails.trackingHistory
													.length -
													1 && (
												<div
													className={`absolute left-[11px] top-6 h-full w-0.5 ${event.completed ? "bg-primary" : "bg-muted"}`}></div>
											)}
											<div className="flex flex-col">
												<div className="flex items-start">
													<div
														className={`absolute left-0 top-1.5 h-[10px] w-[10px] rounded-full ${event.completed ? "bg-primary" : "bg-muted"}`}></div>
													<div>
