...
const ProductDetail: React.FC = () => {
	...
	const scroll = (direction: "left" | "right") => {
		const container =
			document.getElementById("image-scroll");
		if (!container) return;
	...
	if (!product)
		return (
			<div
				className="loader min-h-screen flex flex-col 
	...
	return (
		product && (
			<div className="min-h-screen dark:bg-[#121212] px-1 pt-24">
				<div
          ...
          mx-auto px-4 sm:px-6 lg:px-8">
					<div className="overflow-hidden">
						<div className="flex flex-col sm:flex-row">
							{/* Image Section */}
							<div
								className="md:w-1/2 sm:w-56 w-full mx-auto p-6 
              space-y-6">
								{/* Main Image */}
								<div
				...
				<div
					className="btns text-black dark:text-white max-w-7xl
