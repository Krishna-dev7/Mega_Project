...
const mockProduct = {
  ...
  price: 99.99,
  countInStock: 25,
  description: "This is a sample product description that is longer than 10 characters.",
...
export default function EditProductPage() {
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files) {
      ...
      const newImages: ProductImage[] = fileArray.map((file) => ({
  ...
  if (isLoading) {
    return (
      <div className="container mx-auto py-10 flex items-center justify-center min-h-[400px] dark">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Product owner name" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                    ...
                    {productImages.map((image, index) => (
                      <div key={index} className="relative group">
                        <div className="aspect-square rounded-md overflow-hidden bg-gray-100 border">
                          ...
                          />
                          {image.isNew && (
                            <div className="absolute top-1 left-1 bg-blue-500 text-white text-xs px-1 rounded">New</div>
                          )}
                        </div>
                        <button
                          type="button"
