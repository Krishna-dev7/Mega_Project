		...
		<div className="h-full">
			<Card className="w-full h-full border-none font-normal bg-transparent ">
				...
				<CardContent>
					<form>
						{/* row first */}
						<div className="group flex sm:flex-row flex-col gap-8
             justify-between items-center ">
							...
							<div className="sm:w-1/2 w-full">
								...
								<Input
									type="text"
									id="mobile"
									placeholder="9080768975"
								/>
							</div>
						</div>

						{/* row 2nd */}
						<div className="group flex sm:flex-row mt-5 gap-8 
            justify-between items-center ">
							<div className="sm:w-1/2 w-full">
                ...
                border-neutral-800 rounded-md">
									...
									<SelectContent className="bg-neutral-800 w-[180px] cursor-pointer">
										<SelectGroup>
											...
											<SelectItem value="Maharastra">
												Maharastra
											</SelectItem>
											<SelectItem value="Punjab">
												Punjab
											</SelectItem>
											<SelectItem value="Ludhiyana">
												Ludhiyana
											</SelectItem>
										</SelectGroup>
									</SelectContent>
                ...
                border-neutral-800 rounded-md">
						...
						{/* row 3rd */}
						<div
							className="group flex sm:flex-row flex-col mt-5 gap-8 
            justify-between items-center ">
							<div className="sm:w-1/2 w-full">
            ...
            justify-between items-center ">
                ...
                border-neutral-800 p-2"
									id="address"
									placeholder="297, Hamsterdam street"></textarea>
							</div>
						</div>
					</form>
				</CardContent>
