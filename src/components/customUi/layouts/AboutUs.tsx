		...
		<div className="min-h-screen bg-zinc-900 text-white overflow-hidden">
			...
			<div className="relative h-screen w-full flex items-center">
				<div className="absolute inset-0 overflow-hidden">
					{/* <img src="https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?q=80&w=2070" alt="cover image" /> */}
				...
				<div className="container mx-auto px-6 relative">
					<div className="max-w-3xl space-y-8">
						...
						<p className="text-2xl text-zinc-300 animate-on-scroll opacity-0 translate-y-8 transition-all duration-1000 delay-300 ease-out">
							Since 1970, we've been crafting experiences
							that transcend ordinary commerce, delivering
						...
						{[
							{
								...
								description:
									"Every piece we create embodies perfection, crafted with meticulous attention to detail.",
							},
							{
								icon: Shield,
								title: "Timeless Heritage",
								description:
									"Five decades of excellence, setting the standard in luxury retail worldwide.",
							},
							{
								icon: Sparkles,
								title: "Innovation First",
								description:
									"Pushing boundaries to create experiences that define the future of luxury.",
							},
						].map((pillar, index) => (
							<div
								key={index}
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
						<div className="animate-on-scroll opacity-0 translate-x-8 transition-all duration-1000">
							...
							<p className="text-xl text-zinc-400 mb-8 leading-relaxed">
								From our humble beginnings as a boutique
								atelier to our current position as a global
								luxury powerhouse, our journey has been
								defined by an unwavering commitment to
								excellence and innovation.
							</p>
							<p className="text-xl text-zinc-400 mb-12 leading-relaxed">
								Today, we continue to push the boundaries of
								what's possible in luxury retail, creating
								experiences that resonate with discerning
								clients worldwide.
							</p>
